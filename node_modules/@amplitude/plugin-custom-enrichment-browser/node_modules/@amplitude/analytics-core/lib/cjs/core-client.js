...
var AmplitudeCore = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.runQueuedFunctions('q', function () { return (_this.isReady = true); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AmplitudeCore.prototype.runQueuedFunctions = function (queueName, onQueueEmpty) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.runQueuedFunctions(queueName, onQueueEmpty)];
                    case 11:
                        _b.sent();
                        return [3 /*break*/, 13];
                    case 12:
                        onQueueEmpty === null || onQueueEmpty === void 0 ? void 0 : onQueueEmpty();
                        _b.label = 13;
    ...
    AmplitudeCore.prototype.process = function (event) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var eventType, result, e_2, message, result;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        if (typeof eventType !== 'string' || eventType.trim().length === 0) {
                            this.config.loggerProvider.error(messages_1.EMPTY_EVENT_TYPE_MESSAGE);
                            return [2 /*return*/, (0, result_builder_1.buildResult)(event, 0, messages_1.EMPTY_EVENT_TYPE_MESSAGE)];
                        }
