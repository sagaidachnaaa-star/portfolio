...
export interface ReactNativeClient extends Client {
     ...
     */
    trackScreenView(screenName: string, eventProperties?: Record<string, any>, eventOptions?: EventOptions): AmplitudeReturn<Result | undefined>;
    /**
     ...
     * @param eventOptions Additional event options to include in the event.
     */
    trackScreenViewOnNavigationStateChange(navigationState: NavigationState | undefined, eventProperties?: Record<string, any>, eventOptions?: EventOptions): AmplitudeReturn<Result | undefined>;
}
