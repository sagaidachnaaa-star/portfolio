...
import { querySelectorAllDeep } from './helpers';
 ...
 */
export var createMutationObservable = function (shadowGate) {
    if (!shadowGate) {
    ...
    return new Observable(function (observer) {
        ...
        var observeShadowRootsWithin = function (host, baseDepth, maxDepth) {
            ...
            collectOpenShadowRoots(host, remaining).forEach(function (_a) {
...
export var createScrollObservable = function () {
    return new Observable(function (observer) {
        ...
        // one observable.
        (_a = getGlobalScope()) === null || _a === void 0 ? void 0 : _a.addEventListener('scroll', handler, { capture: true, passive: true });
        ...
        (_b = getGlobalScope()) === null || _b === void 0 ? void 0 : _b.addEventListener('resize', handler, { passive: true });
        return function () {
            var _a, _b;
            (_a = getGlobalScope()) === null || _a === void 0 ? void 0 : _a.removeEventListener('scroll', handler, { capture: true });
            (_b = getGlobalScope()) === null || _b === void 0 ? void 0 : _b.removeEventListener('resize', handler);
        };
    });
};
...
export var createExposureObservable = function (mutationObservable, selectorAllowlist, registerRescanOrShadowGate, maybeShadowGate) {
    ...
    return new Observable(function (observer) {
        ...
        var observeMatchesInShadow = function (root) {
            ...
            try {
                querySelectorAllDeep(root, selectorString, readGate(shadowGate)).forEach(function (element) {
                    intersectionObserver.observe(element);
                });
            }
            catch (_a) {
