 ...
 */
export var SHADOW_BOUNDARY_DELIMITER = ' >>> ';
/**
 ...
 */
export var SHADOW_CHILD_CHAIN_PREFIX = ':scope > ';
 ...
 */
export function anchorSegmentToShadowScope(segment, scope, isRootAnchored) {
    if (segment && isRootAnchored && isShadowRoot(scope)) {
        return "".concat(SHADOW_CHILD_CHAIN_PREFIX).concat(segment);
    }
    return segment;
}
/**
 ...
 */
export function legacyPathIsRootAnchored(el) {
 ...
 */
export var MAX_SHADOW_COMPOSED_WALK_ITERATIONS = 1024;
/**
 ...
 * ancestor-walk cap.
 */
export var MAX_SHADOW_DOM_TRAVERSAL_NODES = 50000;
/**
 ...
 */
export function walkComposedAncestors(start, maxShadowDepth) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(node !== null && iterations < MAX_SHADOW_COMPOSED_WALK_ITERATIONS)) return [3 /*break*/, 3];
                iterations += 1;
                return [4 /*yield*/, node];
            case 2:
                _a.sent();
 ...
 */
export function collectOpenShadowRoots(root, maxShadowDepth) {
    var found = [];
    if (maxShadowDepth <= 0) {
        return found;
    }
    ...
    while (stack.length && visited < MAX_SHADOW_DOM_TRAVERSAL_NODES) {
        visited += 1;
        var _a = __read(stack.pop(), 2), el = _a[0], depth = _a[1];
 ...
 */
export function segmentWalk(el, maxShadowDepth) {
...
export function resolveSelector(root, selector) {
    var segments = selector.split(SHADOW_BOUNDARY_DELIMITER);
    var scope = root;
    var found = null;
 ...
 */
export function positionalStep(el, shadowAware) {
