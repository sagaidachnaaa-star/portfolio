...
export var DEFAULT_SHADOW_DOM_ENABLED = false;
/** Default number of shadow-boundary crossings to traverse when piercing is on. */
export var DEFAULT_MAX_SHADOW_DOM_DEPTH = 1;
/**
 ...
 */
export var MAX_SHADOW_DOM_DEPTH = 10;
/**
 ...
 */
export function normalizeResolvedConfig(config) {
    var _a;
    return __assign(__assign({}, config), { shadowDomEnabled: (_a = config.shadowDomEnabled) !== null && _a !== void 0 ? _a : DEFAULT_SHADOW_DOM_ENABLED, maxShadowDomDepth: clampShadowDepth(config.maxShadowDomDepth) });
}
