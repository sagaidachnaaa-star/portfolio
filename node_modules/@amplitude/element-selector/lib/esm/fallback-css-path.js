...
export function fallbackCssPath(el, config, options) {
    ...
    while (cursor !== null) {
        ...
        var id = getStableId(cursor, resolved);
        if (id !== null) {
    ...
    if (resolved.shadowDomEnabled && scopeIsShadowRoot && cursor === null) {
        return "".concat(SHADOW_CHILD_CHAIN_PREFIX).concat(path);
    }
    return path;
}
