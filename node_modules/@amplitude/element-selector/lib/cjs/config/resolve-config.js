...
exports.resolveSelectorConfig = exports.normalizeResolvedConfig = exports.DEFAULT_RESOLVED_CONFIG = exports.MAX_SHADOW_DOM_DEPTH = exports.DEFAULT_MAX_SHADOW_DOM_DEPTH = exports.DEFAULT_SHADOW_DOM_ENABLED = void 0;
...
exports.DEFAULT_SHADOW_DOM_ENABLED = false;
/** Default number of shadow-boundary crossings to traverse when piercing is on. */
exports.DEFAULT_MAX_SHADOW_DOM_DEPTH = 1;
/**
 ...
 */
exports.MAX_SHADOW_DOM_DEPTH = 10;
/**
...
exports.DEFAULT_RESOLVED_CONFIG = Object.freeze({
    ...
    shadowDomEnabled: exports.DEFAULT_SHADOW_DOM_ENABLED,
    maxShadowDomDepth: exports.DEFAULT_MAX_SHADOW_DOM_DEPTH,
});
/**
...
function normalizeResolvedConfig(config) {
    var _a;
    return tslib_1.__assign(tslib_1.__assign({}, config), { shadowDomEnabled: (_a = config.shadowDomEnabled) !== null && _a !== void 0 ? _a : exports.DEFAULT_SHADOW_DOM_ENABLED, maxShadowDomDepth: clampShadowDepth(config.maxShadowDomDepth) });
}
exports.normalizeResolvedConfig = normalizeResolvedConfig;
 ...
 */
function clampShadowDepth(depth) {
    if (typeof depth !== 'number' || !Number.isFinite(depth)) {
        return exports.DEFAULT_MAX_SHADOW_DOM_DEPTH;
    }
    return Math.min(Math.max(Math.floor(depth), 1), exports.MAX_SHADOW_DOM_DEPTH);
}
function cloneDefaults() {
    return {
        ...
        shadowDomEnabled: exports.DEFAULT_RESOLVED_CONFIG.shadowDomEnabled,
        maxShadowDomDepth: exports.DEFAULT_RESOLVED_CONFIG.maxShadowDomDepth,
    };
}
