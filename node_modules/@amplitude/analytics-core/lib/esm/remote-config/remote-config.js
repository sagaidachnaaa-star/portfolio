...
var RemoteConfigClient = /** @class */ (function () {
    function RemoteConfigClient(apiKey, logger, serverZone, serverUrl, customFetch, configGroup) {
        if (serverZone === void 0) { serverZone = 'US'; }
        if (configGroup === void 0) { configGroup = RemoteConfigClient.CONFIG_GROUP; }
