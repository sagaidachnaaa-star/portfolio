            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        e = _e.sent();
                        if (e === null) {
                            this.loggerProvider.log("Timeline.apply: Event filtered out by before plugin '".concat(String(plugin.name), "', event: ").concat((0, safe_stringify_1.safeJsonStringify)(event)));
                            resolve({ event: event, code: 0, message: '' });
                            return [2 /*return*/];
                        }
                        else {
                            event = e;
                            this.loggerProvider.log("Timeline.apply: Event after before plugin '".concat(String(plugin.name), "', event: ").concat((0, safe_stringify_1.safeJsonStringify)(event)));
                        }
                        _e.label = 4;
                    case 4:
                    ...
                    case 11:
                        e = _e.sent();
                        if (e === null) {
                            this.loggerProvider.log("Timeline.apply: Event filtered out by enrichment plugin '".concat(String(plugin.name), "', event: ").concat((0, safe_stringify_1.safeJsonStringify)(event)));
                            resolve({ event: event, code: 0, message: '' });
                            return [2 /*return*/];
                        }
                        else {
                            event = e;
                            this.loggerProvider.log("Timeline.apply: Event after enrichment plugin '".concat(String(plugin.name), "', event: ").concat((0, safe_stringify_1.safeJsonStringify)(event)));
                        }
                        _e.label = 12;
                    case 12:
                    ...
                    case 16:
                        ...
                        this.loggerProvider.log("Timeline.apply: Final event before destinations, event: ".concat((0, safe_stringify_1.safeJsonStringify)(event)));
