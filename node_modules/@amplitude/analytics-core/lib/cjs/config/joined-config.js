...
exports.translateRemoteConfigToLocal = exports.transformNetworkTrackingRemoteConfig = exports.mergeUrls = void 0;
 ...
 */
function mergeUrls(urlsExact, urlsRegex, logger) {
    var e_1, _a;
    var regexList = [];
    try {
        for (var _b = tslib_1.__values(urlsRegex !== null && urlsRegex !== void 0 ? urlsRegex : []), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            try {
                ...
                logger.warn("Invalid regex pattern: ".concat(pattern), regexError);
            }
        }
    }
 ...
 */
function transformNetworkTrackingRemoteConfig(networkTracking, logger) {
    var e_2, _a;
    var _b, _c, _d;
    if (typeof networkTracking !== 'object' || networkTracking === null || !((_b = networkTracking.captureRules) === null || _b === void 0 ? void 0 : _b.length)) {
        return undefined;
    }
    var transformed = tslib_1.__assign({}, networkTracking);
    /* istanbul ignore next */
    var captureRules = (_c = transformed.captureRules) !== null && _c !== void 0 ? _c : [];
    try {
        for (var captureRules_1 = tslib_1.__values(captureRules), captureRules_1_1 = captureRules_1.next(); !captureRules_1_1.done; captureRules_1_1 = captureRules_1.next()) {
            ...
            rule.urls = mergeUrls((_d = rule.urls) !== null && _d !== void 0 ? _d : [], rule.urlsRegex, logger);
...
exports.transformNetworkTrackingRemoteConfig = transformNetworkTrackingRemoteConfig;
/**
        ...
        if ((_f = (_e = (_d = config.autocapture) === null || _d === void 0 ? void 0 : _d.networkTracking) === null || _e === void 0 ? void 0 : _e.captureRules) === null || _f === void 0 ? void 0 : _f.length) {
            try {
                for (var _k = tslib_1.__values(config.autocapture.networkTracking.captureRules), _l = _k.next(); !_l.done; _l = _k.next()) {
                    var rule = _l.value;
                    try {
                        for (var _m = (e_5 = void 0, tslib_1.__values(['responseHeaders', 'requestHeaders'])), _o = _m.next(); !_o.done; _o = _m.next()) {
                            var header = _o.value;
