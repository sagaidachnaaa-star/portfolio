...
import { CampaignParser, getGlobalScope, omitUndefined, SpecialEventType, } from '@amplitude/analytics-core';
...
var toEventPropertyCampaign = function (campaign) { return omitUndefined(campaign); };
export var eventPropertyTrackingPlugin = function (options) {
    var _a;
    ...
    var updateCampaignState = function () { return __awaiter(void 0, void 0, void 0, function () {
        var currentCampaign;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new CampaignParser().parse()];
                case 1:
    ...
    return {
        ...
        execute: function (event) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                event.event_properties = __assign(__assign({}, eventPropertyCampaign), event.event_properties);
                return [2 /*return*/, event];
            });
        }); },
